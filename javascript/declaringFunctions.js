...
function initialiseLevelOneBlocks(){
    ...
    new MysteryBox(0, 21, 4, mysteryBox, "mushroom", 1),
    new MysteryBox(0, 22, 8, mysteryBox, "coin", 1),
    new MysteryBox(2, 14, 5, empty, "coin", 1),
    new MysteryBox(3, 3, 4, mysteryBox, "mushroom", 1),
    ...
    new MysteryBox(4, 9, 8, mysteryBox, "mushroom", 1),
...
function initialiseLevelOneSprites(){
  levelSprites.push(
    ...
    new Goomba(0, 20.5625, 0, goomba),
    new Goomba(1, 15.25, 0, goomba),
    new Goomba(2, 2.5625, 0, goomba),
    new Goomba(2, 4.0625, 0, goomba),
    new Goomba(3, 3.75, 5.375, goomba),
    new Goomba(3, 6.5, 8, goomba),
    new Goomba(3, 19.8125, 0, goomba),
    new Goomba(3, 21.3125, 0, goomba),
    new Goomba(4, 23.375, 0, goomba),
    new Goomba(4, 24.8125, 0, goomba),
    new Goomba(5, 1.8125, 0, goomba),
    new Goomba(5, 3.25, 0, goomba),
    new Goomba(6, 23.1875, 0, goomba),
    new Goomba(6, 24.625, 0, goomba)
...
function initialiseLevelText(colour){
  levelText = [];
  levelText.push(
    new Text(screenWidth/50, screenHeight/18 ,"emulogic", screenWidth/50, "left", colour, "Mario "),
    new Text(screenWidth/50, screenHeight*2/18 ,"emulogic", screenWidth/50, "left", colour, score.toString()),
    new Text(screenWidth*3/10, screenHeight*2/18 ,"emulogic", screenWidth/50 , "left", colour, "x" + coinsCollected.toString()),
    new Text(screenWidth*3/5, screenHeight/18 ,"emulogic", screenWidth/50 , "center", colour, "world"),
    new Text(screenWidth*3/5, screenHeight*2/18 ,"emulogic", screenWidth/50 , "center", colour, "1-" + level.toString()),
    new Text(screenWidth*49/50, screenHeight/18 ,"emulogic", screenWidth/50 , "right", colour, "Time"),
    new Text(screenWidth*49/50, screenHeight*2/18 ,"emulogic", screenWidth/50 , "right", colour, gameTime.toString())
  );
}
...
function initialiseLevelTwoBlocks(){
  levelBlocks.push(
    new MysteryBox(0, 10, 4, mysteryBox, "mushroom", 1),
    new MysteryBox(0, 11, 4, mysteryBox, "coin", 1),
    new MysteryBox(0, 12, 4, mysteryBox, "coin", 1),
    new MysteryBox(0, 13, 4, mysteryBox, "coin", 1),
    new MysteryBox(0, 14, 4, mysteryBox, "coin", 1),
    new MysteryBox(1, 4, 5, blueFloatingBlock, "coin", 7),
    new MysteryBox(1, 21, 6, blueFloatingBlock, "star", 1),
    new MysteryBox(2, 19, 5, blueFloatingBlock, "mushroom", 1),
    new MysteryBox(2, 23, 5, blueFloatingBlock, "coin", 1),
    new MysteryBox(3, 14, 11, blueFloatingBlock, "oneUp", 1),
    new MysteryBox(6, 0, 5, blueFloatingBlock, "mushroom", 1),

    new NormalBlock(1, 15, 4, blueFloatingBlock),
    new NormalBlock(1, 17, 6, blueFloatingBlock),
    new NormalBlock(1, 18, 6, blueFloatingBlock),
    new NormalBlock(1, 20, 4, blueFloatingBlock),
    new NormalBlock(2, 23, 4, blueFloatingBlock),

    new MovingPlatform(5, 14.8125, 8.5625, blockSize*3, blockSize/2, movingPlatform, screenHeight/500),
    new MovingPlatform(5, 14.8125, 2.625, blockSize*3, blockSize/2, movingPlatform,screenHeight/500),
    new MovingPlatform(6, 4.6875, 8.25, blockSize*3, blockSize/2, movingPlatform,screenHeight/500),
    new MovingPlatform(6, 4.6875, 0.25, blockSize*3, blockSize/2, movingPlatform,screenHeight/500),
...
function initialiseLevelTwoSprites(){
  levelSprites.push(
  /*
    new Goomba(0, 13.25, 0, blueGoomba),
    new Goomba(0, 14.26, 0, blueGoomba),
    new Goomba(1, 3.625, 0, blueGoomba),
    new Goomba(2, 9.5, 0, blueGoomba),
    new Goomba(2, 12.4375, 0, blueGoomba),
    new Goomba(2, 21.8125, 8, blueGoomba),
    new Goomba(2, 24.75, 2.375, blueGoomba),
    new Goomba(3, 1.4375, 4, blueGoomba),
    new Goomba(3, 20.75, 0, blueGoomba),
    new Goomba(3, 22.1875, 0, blueGoomba),
    new Goomba(3, 23.625, 0, blueGoomba),
    new Goomba(4, 12.4375, 0, blueGoomba),
    new Goomba(5, 7.6875, 1, blueGoomba),
    new Goomba(5, 19.1875, 3, blueGoomba)
*/
  );
}
...
function initialiseLevelThreeBlocks(){
  levelBlocks.push(
    new MovingPlatform(2, 1.6875, 2.5625, blockSize*3, blockSize/2, movingPlatform, screenHeight/500),
    new MovingPlatform(3, 10.9375, 4.9375, blockSize*3, blockSize/2, movingPlatform, screenHeight/500),
    new MovingPlatform(3, 18.9375, 3.9375, blockSize*3, blockSize/2, movingPlatform, screenHeight/500),
    new MovingPlatform(5, 2.875, 6.9375, blockSize*3, blockSize/2, movingPlatform, screenHeight/500),
    new SolidBlock(6,2,1,solidBlock),
    new EndingPole(6, 2.25, 10.5),

    new MysteryBox(2, 9, 3, mysteryBox, "mushroom", 1)
...
function initialiseLevelThreeBackground(){
  levelBackgroundObjects.push(
    new BasicObject(0, groundLevelY - blockSize*5, blockSize*5, blockSize*5, castle),

    new Cloud(0,3.5,10,2),
    new Cloud(0,9.5,6,1),
    new Cloud(0,18.5,11,2),
    new Cloud(1,10.5,6,1),
    new Cloud(1,13.5,7,1),
    new Cloud(1,21.5,2,1),
    new Cloud(2,1.5,10,2),
    new Cloud(2,7.5,6,1),
    new Cloud(2,16.5,11,2),
    new Cloud(3,1.5,2,1),
    new Cloud(3,8.5,6,1),
    new Cloud(3,11.5,7,1),
    new Cloud(3,19.5,2,1),
    new Cloud(3,24.5,10,2),
    new Cloud(4,14.5,11,2),
    new Cloud(4,24.5,2,1),
    new Cloud(5,6.5,6,1),
    new Cloud(5,9.5,7,1),
    new Cloud(5,17.5,2,1),
    new Cloud(5,22.5,10,2),
    new Cloud(6,3.5,6,1),
    new Cloud(6,12.5,11,2),

    new BasicObject(blockSize*155, groundLevelY - blockSize*11, blockSize*9, blockSize*11, bigCastle)
  );
}
function initialiseLevelThreeSprites(){
  levelSprites.push(
    new Goomba(1,15.875,10, goomba),
    new Goomba(1,18.875,10, goomba),
    new Goomba(3,3,8, goomba)
  );
}
